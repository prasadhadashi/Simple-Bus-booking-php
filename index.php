...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">Book Your Bus</a>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>Welcome to our Site, your one-stop solution for convenient and reliable bus travel. Our mission is to make your journey seamless and enjoyable by providing an easy-to-use platform for booking bus tickets across various routes and destinations.

                With a commitment to customer satisfaction, we offer real-time availability, competitive pricing, and a wide selection of bus operators to choose from. Whether you're planning a short trip or a long-distance journey, our user-friendly interface ensures a hassle-free booking experience.</p>
            </div>
        </section>
        <section id="contact">
            <div id="contact-form">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Simple Bus Ticket Booking System | Made with &#10084;&#65039; by Prasad Hadshi
                        </p>
        </footer>
    </div>
